...
contract POR_Groth16_Verifier {
    ...
    /// @notice The verification key for the proof of residence program.
    bytes32 public residenceProgramVKey;
    ...
    /// @param _residenceProgramVKey The verification key for the proof of residence program.
    constructor(
        address _verifier,
        bytes32 _residenceProgramVKey,
        IEAS eas
    ) {
        ...
        verifier = _verifier;
        residenceProgramVKey = _residenceProgramVKey;
        _eas = eas;
    }
